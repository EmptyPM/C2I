        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Card className="glass-card rounded-2xl border border-slate-800/50 bg-gradient-to-br from-slate-900/90 via-slate-950/90 to-slate-900/90 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-300">
            <CardContent className="p-6">
              ...
              <h3 className="text-xl font-bold text-slate-100 mb-2">18.4% Avg Annual Return</h3>
          ...
          <Card className="glass-card rounded-2xl border border-slate-800/50 bg-gradient-to-br from-slate-900/90 via-slate-950/90 to-slate-900/90 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-300">
            <CardContent className="p-6">
              ...
              <h3 className="text-xl font-bold text-slate-100 mb-2">$87 Million+ Invested</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
          ...
          <Card className="glass-card rounded-2xl border border-slate-800/50 bg-gradient-to-br from-slate-900/90 via-slate-950/90 to-slate-900/90 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-300">
            <CardContent className="p-6">
              ...
              <h3 className="text-xl font-bold text-slate-100 mb-2">120,000+ Active Investors</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
          ...
          <Card className="glass-card rounded-2xl border border-slate-800/50 bg-gradient-to-br from-slate-900/90 via-slate-950/90 to-slate-900/90 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-300">
            <CardContent className="p-6">
              ...
              <h3 className="text-xl font-bold text-slate-100 mb-2">97% User Satisfaction</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
          ...
          <Card className="glass-card rounded-2xl border border-slate-800/50 bg-gradient-to-br from-slate-900/90 via-slate-950/90 to-slate-900/90 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-300">
            <CardContent className="p-6">
              ...
              <h3 className="text-xl font-bold text-slate-100 mb-2">Real-time AI Insights</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
          ...
          <Card className="glass-card rounded-2xl border border-slate-800/50 bg-gradient-to-br from-slate-900/90 via-slate-950/90 to-slate-900/90 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-300">
            <CardContent className="p-6">
              ...
              <h3 className="text-xl font-bold text-slate-100 mb-2">Bank-Level Security</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
